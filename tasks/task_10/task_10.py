        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                if submitted:
                    ...
                    ##### YOUR CODE HERE #####
                    generator = QuizGenerator(topic_input, questions, chroma_creator) # Step 3: Initialize a QuizGenerator class using the topic, number of questions, and the chroma collection
